    ...
    <div class="h-full flex flex-col gap-6 font-mono">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 min-h-0">
        <div class="lg:col-span-12 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2 leading-none pb-4">
          <Card glow="amber" title="Matrix Input" subtitle="Verify firmware architecture against target SoC blueprint" class="border-border-subtle">
            <div class="grid lg:grid-cols-2 gap-x-12 gap-y-8 mb-8">
                    ...
                    <div class="flex-1 relative">
                      ...
                      >
                        <For each={STANDARD_PROFILES}>{(p) => (
                          <option value={p.value} class="bg-sidebar text-text-primary">{p.label}</option>
                        )}</For>
                      </select>
              ...
              <div class="grid grid-cols-2 gap-8">
                <div class="space-y-3">
                  ...
                  >
                    <option value="android">Android Open Source Project</option>
                    <option value="linux">Mainline Linux (Armbian)</option>
                    <option value="emuelec">EmuELEC / CoreELEC</option>
                  </Select>
                </div>
                <div class="space-y-3">
