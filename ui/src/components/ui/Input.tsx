  ...
  return (
    <div class="w-full space-y-1.5">
      ...
      <input
        ...
        class={cn(
          "w-full rounded-none border bg-sidebar/50 px-4 py-3 text-xs font-mono text-text-primary placeholder:text-text-muted/50 transition-ui focus:outline-none focus:ring-1 italic font-bold",
          local.error
